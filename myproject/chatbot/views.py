    ...
    if request.method == "POST":
        try:
            ...
            if history_id:
                ...
                history = ChatDetail.objects.create(name=chat_objects[0].screen_name)
